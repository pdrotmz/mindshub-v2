...
import br.com.mindshub.identity.application.usecase.impl.auth.RegisterUserUseCaseImpl;
...
class RegisterUserUseCaseImplTest {
    ...
    private final RegisterUserRequest request = new RegisterUserRequest("pedro", "pedro@example.com", "Password@123", "Password@123");
    ...
    void shouldCreateInactiveUserAndPublishVerificationToken() {
        ...
        assertEquals(Role.STUDENT, users.getValue().getRole());
