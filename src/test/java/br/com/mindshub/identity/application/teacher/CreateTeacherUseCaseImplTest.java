...
import br.com.mindshub.identity.application.usecase.impl.teacher.CreateTeacherUseCaseImpl;
...
class CreateTeacherUseCaseImplTest {
    ...
    @InjectMocks private CreateTeacherUseCaseImpl useCase;
    ...
    void shouldCreateInactiveUserAndPublishVerificationToken() {
        ...
        assertEquals(Role.TEACHER, users.getValue().getRole());
